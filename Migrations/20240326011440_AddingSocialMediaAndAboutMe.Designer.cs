...
namespace API_Museu_da_computacao.Migrations
{
    ...
    [Migration("20240326011440_AddingSocialMediaAndAboutMe")]
    partial class AddingSocialMediaAndAboutMe
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API_Museu_da_computacao.Models.ItemAcervo", b =>
                {
                    ...
                    b.Property<string>("DescricaoCurtaItem")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("DescricaoCurtaItem");
            ...
            modelBuilder.Entity("API_Museu_da_computacao.Models.Noticias", b =>
                {
                    ...
                    b.Property<string>("tagNoticia")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("tagNoticia");
            ...
            modelBuilder.Entity("API_Museu_da_computacao.Models.Usuario", b =>
                {
                    ...
                    b.Property<string>("User_github_link")
                        .HasColumnType("longtext")
                        .HasColumnName("User_github_link");

                    b.Property<string>("User_insta_link")
                        .HasColumnType("longtext")
                        .HasColumnName("User_insta_link");

                    b.Property<string>("User_twitter_link")
                        .HasColumnType("longtext")
                        .HasColumnName("User_twitter_link");
